    ...
    if (t.console = t.console || {
        ...
        n.extend(b.prototype, {
            init: function () {
              ...
              var sinep = window.innerWidth - document.body.offsetWidth;
                r.closeExisting && n.fancybox.close(!0), n("body").addClass("fancybox-active"), !n.fancybox.getInstance() && !1 !== r.hideScrollbar && !n.fancybox.isMobile && e.body.scrollHeight > t.innerHeight && (n("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar{padding-right:' + sinep + 'px;}</style>'), n("body,header").addClass("compensate-for-scrollbar")), i = "", n.each(r.buttons, function (t, e) {
                    i += r.btnTpl[e] || ""
